...
def LnLike(x,data1, data2,sig = 0.4): 
    ...
    deltax = np.zeros(d)
    M = CDM.LCDModel(72, 299792.4580, 0.0, x[0], 1.0-x[0], x[1]) #é criado uma instância do modelo LCDM, fixando constante de hubble atualmente H0 = 72, c = 299792.458km/s, OM_r = 0.
    i=0
